...
module.exports = ChartMaker = (function() {
  ...
  ChartMaker.prototype.getLineTemplate = function(chartType, line, lineCounter) {
    var elem, i, j, k, l, len, len1, len2, len3, len4, len5, len6, len7, m, n, o, p, q, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, result;
    switch (chartType) {
      case 'radar':
      ...
      case 'bar':
        ...
        result += "		</c:" + this.cache + ">\n	</c:" + this.ref + ">\n</c:cat>\n<c:val>\n	<c:numRef>\n		<c:numCache>\n			<c:formatCode>" + this.options.format + "</c:formatCode>\n			<c:ptCount val=\"" + line.data.length + "\"/>";
        ref3 = line.data;
      ...
      case 'pie':
        ...
        result += "<c:cat>\n	<c:strRef>\n		<c:strCache>\n			<c:ptCount val=\"" + line.data.length + "\"/>\n";
        ref6 = line.data;
        for (i = p = 0, len6 = ref6.length; p < len6; i = ++p) {
          elem = ref6[i];
          result += "<c:pt idx=\"" + i + "\">\n	<c:v>" + elem.x + "</c:v>\n</c:pt>";
        }
        result += "		</c:strCache>\n	</c:strRef>\n</c:cat>\n<c:val>\n	<c:numRef>\n		<c:numCache>\n			<c:formatCode>General</c:formatCode>\n			<c:ptCount val=\"" + line.data.length + "\"/>";
        ref7 = line.data;
        for (i = q = 0, len7 = ref7.length; q < len7; i = ++q) {
          elem = ref7[i];
          result += "<c:pt idx=\"" + i + "\">\n	<c:v>" + elem.y + "</c:v>\n</c:pt>";
        }
        result += "			</c:numCache>\n		</c:numRef>\n	</c:val>\n	<c:extLst>\n		<c:ext uri=\"{C3380CC4-5D6E-409C-BE32-E72D297353CC}\"\n			xmlns:c16=\"http://schemas.microsoft.com/office/drawing/2014/chart\">\n			<c16:uniqueId val=\"{00000000-9819-4A27-9D24-58E0D8F9109B}\"/>\n		</c:ext>\n	</c:extLst>\n</c:ser>";
